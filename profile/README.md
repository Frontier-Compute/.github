...
- [`zap1`](https://github.com/Frontier-Compute/zap1) - ZAP1 attestation protocol. BLAKE2b Merkle commitments, Orchard shielded anchoring, 9 binaries, 118 tests, 60 automated checks. [ZIP draft PR #1243](https://github.com/zcash/zips/pull/1243).
